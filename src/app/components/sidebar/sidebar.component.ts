...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    isCollapsed: true,
    children: [
      { path: "parcel-list", title: "สร้าง/ติดตามพัสดุ", type: "link" },
      {
      ...
      { path: "all-items", title: "รายการทั้งหมด", type: "link" },
    ],
  },
  {
    path: "/web/",
    ...
    children: [
      ...
      { path: "cart", title: "รายการรอชําระเงิน", type: "link" },
  ...
  },
  {
    ...
    children: [
      ...
      // { path: "web", title: "สั่งซื้อสินค้า", type: "link" },
      //{ path: "web", title: "รายละเอียดการสั่งซื้อ", type: "link" },
      { path: "pending-payment-list", title: "รายการรอชำระเงิน", type: "link" },
      //{ path: "web", title: "ติดตามสถานะสินค้า", type: "link" },
    ],
  },
  // {
  //   path: "/web/bills",
